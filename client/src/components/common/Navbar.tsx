...
const Navbar: React.FC<NavbarProps> = () => {
  return (
    ...
    >
      <span className="flex gap-4">  <img className="h-[40px]" src="https://framerusercontent.com/images/pgoY8aWMvP7Iybn2dcy0mbCYmlg.png"/> <h1 className="italic text-4xl font-bold ">Bots</h1></span>
